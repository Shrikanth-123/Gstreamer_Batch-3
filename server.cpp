...
static void play_thumbnail(gchar *uri,CustomData *data){
	...
	g_object_set(G_OBJECT(data->filesrc1), "location", "/home/ee213063/Project_Batch-3/thumbnail/thumbnail.jpg", NULL);
	...
	g_object_set(G_OBJECT(data->udpsink2), "host", "10.1.136.123", "port",5000, NULL);
...
int thumbnail(string uri) {
	...
	g_object_set(G_OBJECT(filesink), "location", "/home/ee213063/Project_Batch-3/thumbnail/thumbnail.jpg", NULL);
...
int main(int argc, char *argv[])
{
	...
	string path = "/home/ee213063/Project_Batch-3/source/"; //   path to the directory
  ...
  /*Creating G main loop variable*/
  data.loop = g_main_loop_new(NULL, FALSE);
 
 /* Reading the video path one by one */
 for (auto i : videos) {
	data.video_path= i;
	...
	/* To retrieve the Video codec of a video*/
	...
	g_object_set(G_OBJECT(data.udpsink), "host", "10.1.136.123", "port",5675, NULL);
	g_object_set(G_OBJECT(data.udpsink1), "host", "10.1.136.123", "port",5676, NULL);
